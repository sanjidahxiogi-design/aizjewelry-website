...
<body>
    <header class="header">
        <nav class="container nav-container" style="display:flex; justify-content:space-between; align-items:center; padding:25px 0;">
            <a href="index.html" class="logo" style="display:flex; align-items:center; gap:15px; text-decoration:none; color:#111;">
                <img src="https://sc02.alicdn.com/kf/Se1318a00bc9742468f7f2b69415cb0b7e.png" style="height:50px;">
                <div class="logo-text" style="display:flex; flex-direction:column;"><span style="font-size:1.6rem; font-weight:800; letter-spacing:2px;">AIZ</span><span style="font-size:0.75rem; letter-spacing:4px; color:#c5a059;">JEWELRY</span></div>
            </a>
            <div class="nav-links" style="display:flex; align-items:center; gap:40px;"><a href="index.html" style="text-decoration:none; color:#111; font-weight:600;">HOME</a><a href="contact.html" style="background:#111; color:#fff; padding:14px 30px; text-decoration:none; font-size:0.8rem; font-weight:700;">GET A QUOTE</a></div>
        </nav>
    </header>
    <main>
        <section id="contact" style="width:100%;">
            <div class="container">
                <div class="contact-card" style="display:grid; grid-template-columns:1fr 1.2fr; box-shadow:0 30px 70px rgba(0,0,0,0.12); border-radius:4px; overflow:hidden; background:#fff;">
                    <div class="contact-info" style="background:#111; color:#fff; padding:70px; display:flex; flex-direction:column; justify-content:center;">
                        <h2 style="font-family:'Bodoni Moda', serif; font-size:3.2rem; margin-bottom:25px; line-height:1.1;">Collaborate with Your Brand Partner</h2>
                        <div class="contact-details" style="display:flex; flex-direction:column; gap:30px; margin-top:30px;">
                            <div class="contact-item"><span style="color:#c5a059; font-size:0.75rem; text-transform:uppercase;">EMAIL</span><br><strong>sales@aizjewelry.com</strong></div>
                    ...
                    <div class="contact-form" style="padding:70px; background:#fff; position:relative; display:flex; flex-direction:column; justify-content:center;">
                        <form id="F-REAL" action="https://formsubmit.co/sales@aizjewelry.com" method="POST">
                            <input type="email" placeholder="Business Email" required style="width:100%; padding:18px; margin-bottom:20px; border:1px solid #eee; background:#fcfcfc;">
                            <textarea placeholder="Message" rows="7" required style="width:100%; padding:18px; margin-bottom:25px; border:1px solid #eee; background:#fcfcfc; resize:none;"></textarea>
                            <button type="submit" style="width:100%; background:#111; color:#fff; padding:24px; border:none; font-weight:700; letter-spacing:4px; cursor:pointer; text-transform:uppercase;">INQUIRE NOW</button>
                        </form>
